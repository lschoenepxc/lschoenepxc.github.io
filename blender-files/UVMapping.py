...
# Scale UV-Map
bpy.ops.uv.muv_world_scale_uv_apply_manual(tgt_density=2048, tgt_texture_size=(2376, 1584), origin='CENTER', show_dialog=False, tgt_area_calc_method='MESH', only_selected=True)
print("Scales UV")
# UVW Mapping
